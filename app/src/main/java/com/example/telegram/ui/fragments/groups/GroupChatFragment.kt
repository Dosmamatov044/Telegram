package com.example.telegram.ui.fragments.groups
...
import com.example.telegram.ui.fragments.recycler_view_views.AppViewFactory
...
class GroupChatFragment(private val group: CommonModel) :
    ...
    private fun initFields() {
        ...
        chat_input_message.addTextChangedListener(AppTextWather{
            ...
            when(requestCode){
                CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE -> {
                 ...
                 //   val messageKey = getMessageKey(group.id)
                    ...
                    uploadFileToStorageFromGroup(uri,messageKey,group.id, TYPE_MESSAGE_IMAGE)
                    mSmoothScrollToPosition = true
