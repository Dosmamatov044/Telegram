package com.example.telegram.ui.fragments.main_list
...
import com.example.telegram.ui.fragments.groups.GroupChatFragment
...
class MainListAdapter : RecyclerView.Adapter<MainListAdapter.MainListHolder>() {
    ...
    override fun onBindViewHolder(holder: MainListHolder, position: Int) {
        if (listItems[position].lastMessage.isEmpty()){
            listItems[position].lastMessage="Voice" }
